...
class FactorParser:
    ...
    def _tokenize(self, formula: str) -> List[str]:
        # ⚠️ 이 부분을 수정했습니다. 'ts_Rank', 'ts_ArgMax'와 같은 패턴을 인식하도록 정규식을 개선했습니다.
